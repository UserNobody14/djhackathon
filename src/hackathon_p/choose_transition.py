...
def choose_transition(trackA: TrackInfo, trackB: TrackInfo):
    trackA_info = {
        "bpm": trackA.bpm,
        "key": trackA.key,
    ...
    # Parse the response to get the transition parameters object
    transition_params = json.loads(response)
